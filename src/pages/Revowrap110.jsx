  ...
  return (
    <>
      ...
      <main className="content-wrapper">
        ...
        <section className="row-1 revowrap110">
          <section className="row-1-product">
            <h1 className="row-1-about-company">Revowrap 110</h1>
          </section>
        </section>
        ...
        <section className="product-indepth">
          ...
          <section className="product-detail-product">
            ...
            <p>
              ...
              uniform loading throughout the repair. The "Revowrap110®"
              composite systems are engineered to operate in working
              temperatures from - 50°C to 109°C. Our composite systems can be
        ...
        <section className="product-table-wrapper">
          <img src="./revowrap-110-table.png" className="product-table" />
        </section>
        <section className="product-button-wrapper">
          <a
            className="product-indepth-button"
            href="https://revowrap.com/product/revowrap-110/"
            target="_blank"
          >
